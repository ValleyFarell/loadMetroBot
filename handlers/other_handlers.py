...
from keyboards.keyboards import create_menu_kb, create_navigation_kb
...
async def process_wrong_personal_key(message: Message):
    await message.answer(text=ANSWERS_LEXICON['wrong_personal_key'], reply_markup=create_navigation_kb(2))
